...
use warp::tui_export::{
    ...
    ChangelogRequestType, CommandExecutionSource, ConversationFileExport, ConversationSelection,
    ...
    TerminalModel, TerminalSurface, TerminalSurfaceInit, TuiSlashCommand,
    ...
    fn execute_tui_slash_command(
        ...
        match tui_command {
            ...
            TuiSlashCommand::ExportToClipboard => {
                ...
                {
                    let markdown =
                        conversation.export_to_markdown(Some(self.action_model.as_ref(ctx)));
            ...
            TuiSlashCommand::ExportToFile => {
                ...
                let markdown = conversation.export_to_markdown(Some(self.action_model.as_ref(ctx)));
